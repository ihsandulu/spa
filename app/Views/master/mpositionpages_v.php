            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="font-size:15px;">
                        <div class="col-md-1 font-weight-bold">Jabatan</div>
                        <div class="col-md-11">: <?= $position_name; ?></div>
                    </div>
                </div>
                <div class="table-responsive m-t-40">
                    <table id="example012" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <script>
                                ...
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td class="text-left"><?= ucfirst($usr->pages_name); ?></td>
