                        ...
                        <div class="">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">  
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="room_name">Nama Room:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="room_name" name="room_name" placeholder="" value="<?= $room_name; ?>">
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <button class="btn btn-warning col-md-offset-1 col-md-5" onClick="location.href=<?= site_url("room"); ?>">Back</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $usr = $this->db
                                        ->table("room")
                                        ->join("store", "store.store_id=room.store_id", "left")
                                        ->where("room.store_id",session()->get("store_id"))
