...
<script>
    function cekproductlanjutan(transaction_id) {
        ...
        $.get("<?= base_url(); ?>/cekproductlanjutan", {
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-8 row">
                            ...
                            <div class="col-4">
                                <button onclick="tampilroom();" class="btn btn-info btn-block">Room</button>
                            </div>
                        </div>
                        <div class="col-4">
                ...
                <div class="card-body row">
                    ...
                    <script>
                        function cekpembayaran() {
                            ...
                            $.get("<?= base_url("arraymetodepembayaran"); ?>", {
                                    metodepembayaran_id: pembayaran
                                })
                                .done(function(data) {
                                    $("#arraykode").html(data);
                                });
                    ...
                    <script>
                        ...
                        function plistproduct(type, product_name) {
                            ...
                            if (type == "gambar") {
                                ...
                                $.get("<?= base_url("listproductgambar"); ?>", {
